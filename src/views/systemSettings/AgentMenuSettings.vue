<template>
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="card-data">
                <el-table ref="mainTable" :height="MAX_TABLE_HEIGHT" :data="tableData" style="width: 100%;"
                          size="medium" stripe v-loading='tableLoading'>
                    ...
                    <el-table-column prop="menuName" label="名称" header-align="center">
                        <template slot-scope="scope">
                            ...
                            <i class="el-icon-arrow-down" style="font-weight:bolder;" v-if="scope.row.list && scope.row.list.length>0 && scope.row.arrow == 'down'"
                               @click="toggle(scope.row)"></i>
                            <i class="el-icon-arrow-right" style="font-weight:bolder;" v-if="scope.row.list && scope.row.list.length>0 && scope.row.arrow == 'right'"
                               @click="toggle(scope.row)"></i>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="" label="操作" width="220" fixed="right" align="center">
                        <template slot-scope="scope">
            ...
            <el-dialog :visible.sync="dialog.visible" width="500px" top="5vh" :close-on-click-modal="false">
                <div class="custom-dialog">
                                ...
                                <el-col :span="24">
                                    <el-form-item label="菜单名称:">
                                        <el-input type="text" size="small" clearable
                                                  v-model="formData.menuName"></el-input>
                                    </el-form-item>
                                    <el-form-item label="父菜单Id:">
                                        <el-input type="text" size="small" clearable
                                                  v-model="formData.menuLevel"></el-input>
                                    </el-form-item>
                                    <el-form-item label="排序:">
                                        <el-input type="text" size="small" clearable
                                                  v-model="formData.menuSort"></el-input>
                                    </el-form-item>
                                    <el-form-item label="菜单标识:" v-if="dialog.type === 'add'">
                                        <el-input type="text" size="small" clearable
                                                  v-model="formData.menuModule"></el-input>
                                    </el-form-item>
                                    ...
                                    <!-- <el-form-item label="菜单图标:">
                                        <el-input type="text" size="small" clearable
                                                  v-model="formData.menuIcon"></el-input>
                                    </el-form-item>
                                    <el-form-item label="URL:">
                                        <el-input type="text" size="small" clearable
                                                  v-model="formData.menuUrl"></el-input>
                                    </el-form-item>
                                    <el-form-item label="权限名称:">
                                        <el-input type="text" size="small" clearable
                                                  v-model="formData.menuShiro"></el-input>
                                    </el-form-item> -->
                                </el-col>
                            </el-form>
                        </el-row>
                    ...
                    <div class="dialog-footer">
                        ...
                        <el-button type="primary" icon="el-icon-success" :loading="dialog.loading" @click="save">保存
                        </el-button>
                    </div>
                </div>
            </el-dialog>
    ...
    methods: {
        ...
        queryTableData(type) {
            ...
            if (type == "search" && this.menuName) {
                data = {isAgent: 2, menuName: this.menuName}
            } else {
                data = {isAgent: 2}
            }
