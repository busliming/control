            ...
            <div class="toolbar">
                <el-form :inline="true" :model="queryParams" label-width="120px">
                    <el-form-item label="房间名称：">
                        <el-input v-model="queryParams.conditionsMap.roomName" clearable size="small"></el-input>
                    </el-form-item>
                    <el-form-item label="房间类型：">
                        <el-select v-model="queryParams.conditionsMap.roomType" size="small">
                            <el-option value="" label="全部">全部</el-option>
                            <el-option value="1" label="体验类型">体验类型</el-option>
                            <el-option value="2" label="财富类型">财富类型</el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label=" ">
                ...
                <el-form :inline="true">
                    <el-form-item>
                        ...
                        @click="$router.push({name:'厅主游戏管理'})">返回</el-button>
                    </el-form-item>
                </el-form>
            </div>
            <div class="card-data">
                <el-table ref="mainTable" :height="MAX_TABLE_HEIGHT" :data="tableData" style="width: 100%" size="medium" stripe :cell-style="{textAlign:'center'}"
                    ...
                    <el-table-column :key="Math.random()" prop="multiples" label="游戏倍场" sortable v-if="type == 1 && queryParams.conditionsMap.gameId == 5">
                        <template slot-scope="scope">
                            <span v-if='scope.row.multiples == 1'>4倍场</span>
                            <span v-if='scope.row.multiples == 2'>10倍场</span>
                        </template>
                    </el-table-column>
                    <el-table-column :key="Math.random()" label="结算方式" sortable v-if="type == 3 && queryParams.conditionsMap.gameId == 27">
                        <template slot-scope="scope">
                    ...
                    <el-table-column :key="Math.random()" prop="toppingSeal" label="房间场次" sortable v-if="type == 3 && queryParams.conditionsMap.gameId == 27">
                        <template slot-scope="scope">
                            <span v-if='scope.row.toppingSeal == 1'>4番场</span>
                            <span v-if='scope.row.toppingSeal == 2'>无限番场</span>
                        </template>
                    </el-table-column>
                    <el-table-column :key="Math.random()" prop="roomField" label="游戏底分" sortable v-if="type != 1 && queryParams.conditionsMap.gameId != 7">
                    </el-table-column>
                    <el-table-column :key="Math.random()" prop="roomStatus" label="房间状态" sortable>
                        <template slot-scope="scope">
                    ...
                    <el-table-column :key="Math.random()" prop="roomType" label="房间类型" sortable>
                        <template slot-scope="scope">
                            <el-tag type="warning" v-if="scope.row.roomType =='1'">体验类型</el-tag>
                            <el-tag type="primary" v-else-if="scope.row.roomType =='2'">财富类型</el-tag>
                            <el-tag type="info" v-else>未知</el-tag>
                        </template>
                    </el-table-column>
                    <el-table-column prop="minMoney" label="最低携带金额" sortable></el-table-column>
                    <el-table-column :key="Math.random()" prop="" label="下注限红" sortable v-if="type == '1'" >
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="roomPersons" label="房间人数" sortable></el-table-column>
                    <el-table-column prop="taxRatio" label="税收(%)" sortable></el-table-column>
                    <el-table-column prop="" label="操作" width="240" fixed="right">
                        <template slot-scope="scope">
                            ...
                            <template v-if="scope.row.roomStatus=='2'">
                ...
                <div class="custom-dialog">
                    ...
                    <div class="dialog-body">
                        ...
                        <template v-if="dialog.type == 1">
                            <el-row>
                                <el-form label-width="150px">
                                    ...
                                    <el-col :span="11">
                                        ...
                                        <el-form-item label="倍数场次:" v-if="queryParams.conditionsMap.gameId == 5">
                            ...
                            <el-row v-if="queryParams.conditionsMap.gameId != 26">
                                <el-form label-width="150px">
                        ...
                        <template v-if="dialog.type == 3">
                            <el-row v-if="queryParams.conditionsMap.gameId != 27">
                                <el-form label-width="150px">
                                    <h3 style="margin:25px">房间基本配置</h3>
                                    <el-col :span="11">
                                        <el-form-item label="房间名称:">
                                        ...
                                        <el-form-item label="游戏底分:" v-if="queryParams.conditionsMap.gameId != 7 && queryParams.conditionsMap.gameId != 11">
                                            <el-input type="number" size="small" v-model.number="formData.type3.roomField"></el-input>
                                        </el-form-item>
                                        <el-form-item label="游戏底分:" v-if="queryParams.conditionsMap.gameId == 11">
                                    ...
                                    <el-col :span="1" v-if="queryParams.conditionsMap.gameId != 11">
                                    ...
                                    <el-col :span="11">
                                        ...
                                        <el-form-item label="最低携带金额:" v-if="queryParams.conditionsMap.gameId != 15 && queryParams.conditionsMap.gameId != 22">
                                    ...
                                    <el-col :span="1" v-if="queryParams.conditionsMap.gameId != 15 && queryParams.conditionsMap.gameId != 22">
                            ...
                            <el-row>
                                <el-form label-width="150px">
                                    ...
                                    <el-col :span="11">
                                        ...
                                        <el-form-item label="叫分/抢庄时间(秒):" v-if="queryParams.conditionsMap.gameId != 15 && queryParams.conditionsMap.gameId != 17 &&
                                        queryParams.conditionsMap.gameId != 11 && queryParams.conditionsMap.gameId != 20 && queryParams.conditionsMap.gameId != 22 
                                        && queryParams.conditionsMap.gameId != 27">
                                            <el-input type="number" size="small" v-model.number="formData.type3.callTime"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="1" v-if="queryParams.conditionsMap.gameId != 15 && queryParams.conditionsMap.gameId != 17 
                                    && queryParams.conditionsMap.gameId != 11 && queryParams.conditionsMap.gameId != 20 && queryParams.conditionsMap.gameId != 22 
                                    && queryParams.conditionsMap.gameId != 27">
                                    ...
                                    <el-col :span="1" v-if='queryParams.conditionsMap.gameId != 7'>
                            ...
                            <!-- 扎金花其他设置 -->
                            <el-row  v-if="queryParams.conditionsMap.gameId == 11">
                                <el-form label-width="150px">
                    ...
                    <div class="dialog-footer">
                        <p class="cansave" v-if="dialog.wordShow">需要先禁用房间，才能保存新的配置参数!</p>
                        ...
                        <el-button type="primary" icon="el-icon-success" :loading="dialog.loading" @click="judge" :disabled="dialog.wordShow">保存</el-button>
                    </div>
                </div>
            </el-dialog>
        </div>
...
export default {
    ...
    mounted(){
        this.queryParams.conditionsMap.gameId = String(this.$route.params.gameId)
        this.queryParams.conditionsMap.siteId = String(this.$route.params.siteId)
        this.queryTableData()
    ...
    methods:{
        ...
        queryTableData(type){
            ...
            request.getRoomPage(this.queryParams).then(res => {
                for(var item of res.rows){  //德州 21点列表数据-最低携带金额显示为携带金额1
                    if(item.gameId == 15 || item.gameId == 22){
                        item.minMoney = item.texasMoney1
                    }
                    item.taxRatio = item.taxRatio*100
                }
                this.type = res.rows[0].gameType
        ...
        edit(row){
            ...
            this.dialog.wordShow = row.roomStatus == 1 ? true : false;
            this.dialog.loading = true
            var data = {
                gameId:this.queryParams.conditionsMap.gameId,
                gameType:row.gameType,
                roomId:row.id,
                siteId:this.queryParams.conditionsMap.siteId,
            }
            request.editGameRoomConfig(data).then(res => {
                if(res.code == '200'){
                    ...
                    res.data.allowPlayerGame =  res.data.allowPlayerGame == 1 ? true : false
                    res.data.allowLastTimePlay =  res.data.allowLastTimePlay == 1 ? true : false
                    res.data.allowIpEqualPlay =  res.data.allowIpEqualPlay == 1 ? true : false
                    res.data.taxRatio = res.data.taxRatio*100
                    res.data.pumpRate = res.data.pumpRate*100
        ...
        setDialogData(obj){
            for (let item in this.formData['type'+this.dialog.type]) {
                this.formData['type'+this.dialog.type][item] = obj[item] ? obj[item] : 0
            }
        },
        //删除按钮
        del(row){
            ...
            if(row.roomStatus == 1){ //房间为启用状态
                this.$alert("需要先将房间设置为禁用状态，才能删除该房间", '提示', {
                ...
                this.$confirm("确定要删除该房间吗？", '提示', {
                    ...
                    request.editGameRoomConfig(data1).then(res => { //先查询
                        var data2 = {
                            gameId: this.queryParams.conditionsMap.gameId,
                            roomId: res.data.roomId,
                            roomConfigId: res.data.roomConfigId,
                            siteId: this.queryParams.conditionsMap.siteId,
                            gameType: row.gameType,
                        }
                        request.deleteRoomConfig(data2).then(resb => { //再删除
                            this.tableLoading = false;
                            if (resb.code === '200') {
                                this.$notify.success({title:resb.msg});
                                this.queryTableData();
                            } else {
                                this.$notify.error({title:resb.msg})
                            }
                        })
                    })
                }).catch(() => {
        ...
        save(){
            ...
            this.dialog.loading = true
            data.siteId = String(this.$route.params.siteId)
            data.gameId = String(this.$route.params.gameId)
            data.id = this.roomConfigId
            data.gameRoomId = this.roomId
        ...
        judge(){
            ...
            try{
                ...
                if(this.dialog.type == 1){
                    ...
                    if(this.queryParams.conditionsMap.gameId == 5 && t1.multiples === ''){
                        throw str
                    }
                    ...
                    if(t1.chips1 === '' || t1.chips2 === '' || t1.chips3 === '' || t1.chips4 === '' || t1.chips5 === '' || t1.chips6 === ''){
                        throw str
                    }
                    ...
                    if(this.queryParams.conditionsMap.gameId != 26){ //森林舞会无上庄
                        if(t1.sysBanker){//允许玩家上庄
                            if(t1.bankerCond === '' || t1.addedCond === '' || t1.bankerTime === '' || t1.addedTime === ''){
                                throw str
                            }
                        }
                    ...
                    if(t1.robotJoining){ //允许机器人加入
                        if(t1.robotGold1 === '' || t1.robotGold2 === '' || t1.robotCount1 === '' || t1.robotCount2 === ''
                        || t1.robotMinChipsCount === '' || t1.robotMaxChipsCount === '' || t1.robotMinHaveScore === '' 
                        || t1.robotMaxHaveScore === '' || t1.robotMinRobotPlayCount === '' || t1.robotMaxRobotPlayCount === '' 
                        || t1.robotMinTakeScore === '' || t1.robotMaxTakeScore === '' || t1.robotBettingByBankerScore === '' 
                        || t1.robotMinChangeNickName === '' || t1.robotMaxChangeNickName === '' || t1.robotTimidRobotPro === ''
                        || t1.robotNomalRobotPro === '' || t1.robotBoldRobotPro === '' || t1.robotTimidBettingPro === ''
                        || t1.robotNomalBettingPro === '' || t1.robotBoldBettingPro === ''){
                            throw str
                        }
                        ...
                        if(t1.robotMinHaveScore < t1.minMoney){
                            throw '取钱范围最小值不得小于最低携带金额'
                        }
                ...
                if(this.dialog.type == 2){
                    ...
                    if(!t2.roomName || t2.minMoney === '' || t2.roomField === '' || t2.turretInitRank === '' || t2.chargeValue === ''){
                        throw str
                    }
                    ...
                    if(t2.robotJoining){ //允许机器人加入
                        ...
                        if(t2.robotMinHaveScore < t2.minMoney){
                            throw '机器人取钱范围最小值不得小于最低携带金额'
                        }
                ...
                if(this.dialog.type == 3){
                    ...
                    if(this.queryParams.conditionsMap.gameId != 7 && this.queryParams.conditionsMap.gameId != 15 && this.queryParams.conditionsMap.gameId != 22){
                        if(t3.roomField === ''){
                            throw str
                        }
                    ...
                    if(this.queryParams.conditionsMap.gameId != 15 && this.queryParams.conditionsMap.gameId != 22){ //不为德州或21点
                        if(t3.minMoney === ''){
                            throw str
                        }
                    }
                    if(this.queryParams.conditionsMap.gameId == 11){
                        if(t3.roomLimit === ''){
                            throw str
                        }
                    ...
                    if(this.queryParams.conditionsMap.gameId == 15 || this.queryParams.conditionsMap.gameId == 22){ //德州 21点
                    ...
                    if(this.queryParams.conditionsMap.gameId == 27){ //血战到底
                    ...
                    if(t3.betTime <= 4 && this.$route.params.gameId=='22'){
                        throw "出牌/下注时间不能低于5秒"
                    }
                    ...
                    if(this.queryParams.conditionsMap.gameId != 11 && this.queryParams.conditionsMap.gameId != 15 && this.queryParams.conditionsMap.gameId != 17 
                    && this.queryParams.conditionsMap.gameId != 20 && this.queryParams.conditionsMap.gameId != 22 && this.queryParams.conditionsMap.gameId != 27){
                        if(t3.callTime === ''){
                            throw str
                        }
                    ...
                    if(t3.robotJoining){ //允许机器人加入
                        ...
                        if(this.queryParams.conditionsMap.gameId == 15 || this.queryParams.conditionsMap.gameId == 22){ //德州 21点
                           ...
                           //texasMoney2:'',//携带金额2 德州 21点
                            ...
                            if(t3.robotMinHaveScore < t3.texasMoney1 || t3.robotMinHaveScore  > t3.texasMoney2){
                                throw "机器人取钱最低范围不能低于携带金额最小金额或高于携带金额最大金额"
                            }
                            if(t3.robotMinTakeScore < t3.texasMoney1 || t3.robotMinTakeScore  > t3.texasMoney2){
                                throw "机器人取钱最低不能低于携带金额最小金额或高于携带金额最大金额"
                            }
                            if(t3.robotMaxHaveScore > t3.texasMoney2 || t3.robotMaxTakeScore > t3.texasMoney2){
                                throw "机器人取钱不能大于携带金额最大金额"
                            }
                        }else{
                        ...
                        if(t3.robotMinHaveScore < t3.minMoney){
                            throw '机器人取钱范围最小值不得小于最低携带金额'
                        }
        ...
        defaultOut(){
            ...
            if (str.indexOf('体验房') !== -1) {
                index = 0;
                if(JSON.stringify(defaultData.defaultSettings[String(this.$route.params.gameId)][index]) != '{}'){ //有体验房配置
                    txt = '是否需用使用默认体验房配置？';
                }
            }
            ...
            if (txt) {
                this.$confirm(txt, '提示', {
                    ...
                    let obj = defaultData.defaultSettings[this.$route.params.gameId][index];
                    for (let key in obj) {
        ...
        changeSiteState(row) {
            ...
            this.$confirm(msg, '提示', {
                ...
                this.tableLoading = true;
                request.updateTbGameRoom(data).then(res => {
                    this.tableLoading = false;
                    if (res.code === '200') {
                        this.$notify.success({title:res.msg});
                        this.queryTableData();
...
.cansave{color: red;text-align: center;margin: 10px 0}
